<div align="center">
  ...
  <p><strong>Локальная визуальная база знаний для заметок, изображений, видео и связей между ними.</strong></p>
  ...
  <p>
    <img src="https://img.shields.io/badge/version-3.4.1-e6158b?style=flat-square" alt="Версия 3.4.1">
...
| **Изображения и видео** | Медиа хранится рядом с контекстом, отображается на холсте и открывается во встроенном просмотрщике. |
...
1. **Соберите материал.** Создайте текстовую заметку или перетащите в проект изображения и видео.
...
| **`.md`** | Текстовые заметки и связи между ними без медиа — удобно для Git, документации и других Markdown-редакторов. |
