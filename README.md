<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-3.11.0-e6158b?style=flat-square" alt="Версия 3.11.0">
...
| **Командная палитра** | `Ctrl+Space` или двойное нажатие правого `Shift` открывает единый поиск по командам и узлам. |
| **Множественный выбор** | Удобная работа сразу с группой узлов: выделение рамкой, перенос и удаление. |
| **Буфер обмена и история** | Копирование и вставка узлов внутри проекта, обмен текстом и изображениями через системный буфер, отмена и повтор действий. |
...
| Открыть или закрыть палитру команд | `Ctrl+Space` или дважды правый `Shift` |
| Открыть поиск | `Ctrl+F` |
| Сохранить | `Ctrl+S` |
| Выбрать все узлы | `Ctrl+A` |
| Копировать / вставить выбранные узлы | `Ctrl+C` / `Ctrl+V` |
| Обмен текстом и изображениями через системный буфер | `Ctrl+Shift+C` / `Ctrl+Shift+V` |
| Отменить / повторить действие | `Ctrl+Z` / `Ctrl+Y` или `Ctrl+Shift+Z` |
